	...
	const contactInfo = [
		{
			...
			label: 'Email',
			value: 'abineshkalyan2002@gmail.com',
			link: 'mailto:abineshkalyan2002@gmail.com'
		},
		{
			icon: <Phone className="w-5 h-5" />,
			label: 'Phone',
			value: '+919159447439',
			link: 'tel:+919159447439'
		},
		{
	...
	const socialLinks = [
		{
			...
			label: 'GitHub',
			link: 'https://github.com/abinesh2323'
		},
		{
			icon: <Linkedin className="w-5 h-5" />,
			label: 'LinkedIn',
			link: 'https://www.linkedin.com/in/abinesh-kalyanasundaram-369494322'
		},
		{
			icon: <MessageCircle className="w-5 h-5" />,
			label: 'WhatsApp',
			link: 'https://wa.me/+919159447439'
		}
	];
